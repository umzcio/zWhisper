...
enum BuiltInModes {
    ...
    static let email = Mode(
        ...
        instructions: "Rewrite the dictation as a professional email, under 120 words, with a greeting and sign-off. If the context contains an email thread, this is a REPLY to that thread — answer its questions and reference it; otherwise write a fresh draft.",
    ...
    static let message = Mode(
        ...
        instructions: "Rewrite the dictation as a short casual chat message. Fix grammar lightly but preserve tone. Emoji allowed. Output only the message text.",
    ...
    static let note = Mode(
        ...
        instructions: "Turn the dictation into a structured note with a short title and bullet points. Output only the note.",
        readsSelectedText: false,
        readsClipboard: false,
        autoActivationRules: [],
        shortcutIndex: 3,
    ...
    static let meeting = Mode(
        ...
        instructions: "Extract action items from the dictation as a list, assigning owners and due dates where mentioned. Output only the list.",
        readsSelectedText: true,
        readsClipboard: false,
        autoActivationRules: [],
        shortcutIndex: 4,
    ...
    static let writeForMe = Mode(
        ...
        instructions: "Write the requested text based on the dictation. Match the requested tone and length. Output only the written text itself — not a description of it.",
        readsSelectedText: false,
        readsClipboard: false,
        autoActivationRules: [],
        shortcutIndex: 6,
